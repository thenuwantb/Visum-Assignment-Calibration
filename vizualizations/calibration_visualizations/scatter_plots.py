...
ax1.scatter(stops_merged_df['PASSTRANSDIR(AP)_OBS'], stops_merged_df['PASSTRANSDIR(AP)_SIM'], alpha=0.7, color = 'teal', edgecolors='none', s = scatter_size)
...
ax2.scatter(stops_merged_df['PASSTRANSWALKBOARD(AP)_OBS'], stops_merged_df['PASSTRANSWALKBOARD(AP)_SIM'], alpha=0.7, color = 'teal', edgecolors='none', s = scatter_size)
...
ax3.scatter(stops_merged_df['PASSTRANSALIGHTWALK(AP)_OBS'], stops_merged_df['PASSTRANSALIGHTWALK(AP)_SIM'], alpha=0.7, color = 'teal', edgecolors='none', s = scatter_size)
...
ax4.scatter(stops_merged_df['PASSTRANSTOTAL(AP)_OBS'], stops_merged_df['PASSTRANSTOTAL(AP)_SIM'], alpha=0.7, color = 'teal', edgecolors='none', s = scatter_size)
...
ax5.scatter(stops_merged_df['PASSTHROUGHSTOP(AP)_OBS'], stops_merged_df['PASSTHROUGHSTOP(AP)_SIM'], alpha=0.7, color = 'teal', edgecolors='none', s = scatter_size)
...
ax6.scatter(stops_merged_df['PASSTHROUGHNOSTOP(AP)_OBS'], stops_merged_df['PASSTHROUGHNOSTOP(AP)_SIM'], alpha=0.7, color = 'teal', edgecolors='none', s = scatter_size)
...
ax10.scatter(line_routes_cleaned_df['PTRIPSUNLINKED2(AP)_OBS'], line_routes_cleaned_df['PTRIPSUNLINKED2(AP)_SIM'], alpha=0.7, color = 'teal', edgecolors='none')
ax10.plot(line_routes_cleaned_df['PTRIPSUNLINKED2(AP)_OBS'], line_routes_cleaned_df['PTRIPSUNLINKED2(AP)_OBS'], linestyle=':', color='dimgray', alpha = 0.7)
...
ax11.scatter(bus_df['PTRIPSUNLINKED(AP)_OBS'], bus_df['PTRIPSUNLINKED(AP)_SIM'], alpha=0.7, color = 'teal', edgecolors='none', s = scatter_size)
...
ax12.scatter(premium_df['PTRIPSUNLINKED(AP)_OBS'], premium_df['PTRIPSUNLINKED(AP)_SIM'], alpha=0.7, color = 'teal', edgecolors='none', s = scatter_size)
ax12.plot(premium_df['PTRIPSUNLINKED(AP)_SIM'], premium_df['PTRIPSUNLINKED(AP)_SIM'], linestyle=':', color='dimgray', alpha = 0.7)
ax12.set_title('Premium Bus Only', fontsize = subplot_title_size)

ax13.scatter(bus_premium_df['PTRIPSUNLINKED(AP)_OBS'], bus_premium_df['PTRIPSUNLINKED(AP)_SIM'], alpha=0.7, color = 'teal', edgecolors='none', s = scatter_size)
ax13.plot(bus_premium_df['PTRIPSUNLINKED(AP)_OBS'], bus_premium_df['PTRIPSUNLINKED(AP)_OBS'], linestyle=':', color='dimgray', alpha = 0.7)
ax13.set_title('Standard and Premium Bus', fontsize = subplot_title_size)

ax14.scatter(lrt_df['PTRIPSUNLINKED(AP)_OBS'], lrt_df['PTRIPSUNLINKED(AP)_SIM'], alpha=0.7, color = 'teal', edgecolors='none', s = scatter_size)
...
ax15.scatter(mrt_df['PTRIPSUNLINKED(AP)_OBS'], mrt_df['PTRIPSUNLINKED(AP)_SIM'], alpha=0.7, color = 'teal', edgecolors='none', s = scatter_size)
...
ax16.scatter(lrt_mrt_df['PTRIPSUNLINKED(AP)_OBS'], lrt_mrt_df['PTRIPSUNLINKED(AP)_SIM'], alpha=0.7, color = 'teal', edgecolors='none', s = scatter_size)
ax16.plot(lrt_mrt_df['PTRIPSUNLINKED(AP)_OBS'], lrt_mrt_df['PTRIPSUNLINKED(AP)_OBS'], linestyle=':', color='dimgray', alpha = 0.7)
