...
#save paths
save_path_modewise = "C:\\Users\\thenu\\OneDrive - tum.de\\Thesis\\1_Coding\\Experiments\\27022020_singapore_network\\results\\singapore_final_plots\\plots_with_custom_grid lines\\scatter\\test_overall.svg"
save_path_transfer_type = "C:\\Users\\thenu\\OneDrive - tum.de\\Thesis\\1_Coding\\Experiments\\27022020_singapore_network\\results\\singapore_final_plots\\plots_with_custom_grid lines\\scatter\\test_transfer_type_22052020_1.svg"
...
scatter_plot_axis(ax1, vd_bus_df['PTRIPSUNLINKED(AP)_OBS'], vd_bus_df['PTRIPSUNLINKED(AP)_SIM'], color=scatter_color_vd)
ax1.set_title("(a.1) Pax. boardings - Bus line routes", fontsize=subplot_title_size)
scatter_plot_axis(ax2, ig_bus_df['PTRIPSUNLINKED(AP)_OBS'], ig_bus_df['PTRIPSUNLINKED(AP)_SIM'], color=scatter_color_ig)
ax2.set_title("(a.2) Pax. boardings - Bus line routes", fontsize=subplot_title_size)
scatter_plot_axis(ax3, cal_bus_df['PTRIPSUNLINKED(AP)_OBS'], cal_bus_df['PTRIPSUNLINKED(AP)_SIM'], color=scatter_color_cal)
ax3.set_title("(a.3) Pax. boardings - Bus line routes", fontsize=subplot_title_size)

scatter_plot_axis(ax4, vd_rail_df['PTRIPSUNLINKED(AP)_OBS'], vd_rail_df['PTRIPSUNLINKED(AP)_SIM'], color=scatter_color_vd)
ax4.set_title("(b.1) Pax. boardings - LRT & MRT line routes", fontsize=subplot_title_size)
scatter_plot_axis(ax5, ig_rail_df['PTRIPSUNLINKED(AP)_OBS'], ig_rail_df['PTRIPSUNLINKED(AP)_SIM'], color=scatter_color_ig)
ax5.set_title("(b.2) Pax. boardings - LRT & MRT line routes", fontsize=subplot_title_size)
scatter_plot_axis(ax6, cal_rail_df['PTRIPSUNLINKED(AP)_OBS'], cal_rail_df['PTRIPSUNLINKED(AP)_SIM'], color=scatter_color_cal)
ax6.set_title("(b.3) Pax. boardings - LRT & MRT line routes", fontsize=subplot_title_size)

scatter_plot_axis(ax7, vd_stops_merged_df['PASSTRANSTOTAL(AP)_OBS'], vd_stops_merged_df['PASSTRANSTOTAL(AP)_SIM'], color=scatter_color_vd)
ax7.set_title("(c.1) Pax. transfers - Total", fontsize=subplot_title_size)
scatter_plot_axis(ax8, ig_stops_merged_df['PASSTRANSTOTAL(AP)_OBS'], ig_stops_merged_df['PASSTRANSTOTAL(AP)_SIM'], color=scatter_color_ig)
ax8.set_title("(c.2) Pax. transfers - Total", fontsize=subplot_title_size)
scatter_plot_axis(ax9, cal_stops_merged_df['PASSTRANSTOTAL(AP)_OBS'], cal_stops_merged_df['PASSTRANSTOTAL(AP)_SIM'], color=scatter_color_cal)
...
scatter_plot_axis(ax10, vd_stops_merged_df['PASSTRANSALIGHTWALK(AP)_OBS'], vd_stops_merged_df['PASSTRANSALIGHTWALK(AP)_SIM'], color=scatter_color_vd)
ax10.set_title("(a.1) Pax. transfers - alight walk", fontsize=subplot_title_size)
scatter_plot_axis(ax11, ig_stops_merged_df['PASSTRANSALIGHTWALK(AP)_OBS'], ig_stops_merged_df['PASSTRANSALIGHTWALK(AP)_SIM'], color=scatter_color_ig)
ax11.set_title("(a.2) Pax. transfers - alight walk", fontsize=subplot_title_size)
scatter_plot_axis(ax12, cal_stops_merged_df['PASSTRANSALIGHTWALK(AP)_OBS'], cal_stops_merged_df['PASSTRANSALIGHTWALK(AP)_SIM'], color=scatter_color_cal)
ax12.set_title("(a.3) Pax. transfers - alight walk", fontsize=subplot_title_size)

scatter_plot_axis(ax13, vd_stops_merged_df['PASSTRANSWALKBOARD(AP)_OBS'], vd_stops_merged_df['PASSTRANSWALKBOARD(AP)_SIM'], color=scatter_color_vd)
ax13.set_title("(b.1) Pax. transfers - walk board", fontsize=subplot_title_size)
scatter_plot_axis(ax14, ig_stops_merged_df['PASSTRANSWALKBOARD(AP)_OBS'], ig_stops_merged_df['PASSTRANSWALKBOARD(AP)_SIM'], color=scatter_color_ig)
ax14.set_title("(b.2) Pax. transfers - walk board", fontsize=subplot_title_size)
scatter_plot_axis(ax15, cal_stops_merged_df['PASSTRANSWALKBOARD(AP)_OBS'], cal_stops_merged_df['PASSTRANSWALKBOARD(AP)_SIM'], color=scatter_color_cal)
ax15.set_title("(b.3) Pax. transfers - walk board", fontsize=subplot_title_size)

scatter_plot_axis(ax16, vd_stops_merged_df['PASSTRANSDIR(AP)_OBS'], vd_stops_merged_df['PASSTRANSDIR(AP)_SIM'], color=scatter_color_vd)
ax16.set_title("(c.1) Pax. transfers - direct", fontsize=subplot_title_size)
scatter_plot_axis(ax17, ig_stops_merged_df['PASSTRANSDIR(AP)_OBS'], ig_stops_merged_df['PASSTRANSDIR(AP)_SIM'], color=scatter_color_ig)
ax17.set_title("(c.2) Pax. transfers - direct", fontsize=subplot_title_size)
scatter_plot_axis(ax18, cal_stops_merged_df['PASSTRANSDIR(AP)_OBS'], cal_stops_merged_df['PASSTRANSDIR(AP)_SIM'], color=scatter_color_cal)
...
save_path_transfer_type = "C:\\Users\\thenu\\OneDrive - tum.de\\Thesis\\1_Coding\\Experiments\\27022020_singapore_network\\results\\singapore_final_plots\\plots_with_custom_grid lines\\scatter\\test_transfer_flow_mode_line_width.svg"
...
scatter_plot_axis_2(ax19, cal_bus_df['PTRIPSUNLINKED0(AP)_OBS'], cal_bus_df['PTRIPSUNLINKED0(AP)_SIM'], color=scatter_color_cal)
ax19.set_title("(a.1) Pax. trips : 0 transfers - Bus", fontsize=subplot_title_size)
scatter_plot_axis_2(ax20, cal_rail_df['PTRIPSUNLINKED0(AP)_OBS'], cal_rail_df['PTRIPSUNLINKED0(AP)_SIM'], color=scatter_color_cal)
ax20.set_title("(a.2) Pax. trips : 0 transfers - LRT & MRT", fontsize=subplot_title_size)

scatter_plot_axis_2(ax21, cal_bus_df['PTRIPSUNLINKED1(AP)_OBS'], cal_bus_df['PTRIPSUNLINKED1(AP)_SIM'], color=scatter_color_cal)
ax21.set_title("(b.1) Pax. trips : 1 transfer - Bus", fontsize=subplot_title_size)
scatter_plot_axis_2(ax22, cal_rail_df['PTRIPSUNLINKED1(AP)_OBS'], cal_rail_df['PTRIPSUNLINKED1(AP)_SIM'], color=scatter_color_cal)
ax22.set_title("(b.2) Pax. trips : 1 transfer - LRT & MRT", fontsize=subplot_title_size)

scatter_plot_axis_2(ax23, cal_bus_df['PTRIPSUNLINKED2(AP)_OBS'], cal_bus_df['PTRIPSUNLINKED2(AP)_SIM'], color=scatter_color_cal)
ax23.set_title("(c.1) Pax. trips : 2 transfers - Bus", fontsize=subplot_title_size)
scatter_plot_axis_2(ax24, cal_rail_df['PTRIPSUNLINKED2(AP)_OBS'], cal_rail_df['PTRIPSUNLINKED2(AP)_SIM'], color=scatter_color_cal)
ax24.set_title("(c.2) Pax. trips : 2 transfers - LRT & MRT", fontsize=subplot_title_size)

scatter_plot_axis_2(ax25, cal_bus_df['PTRIPSUNLINKED>2(AP)_OBS'], cal_bus_df['PTRIPSUNLINKED>2(AP)_SIM'], color=scatter_color_cal)
ax25.set_title("(d.1) Pax. trips : > 2 transfers - Bus", fontsize=subplot_title_size)
scatter_plot_axis_2(ax26, cal_rail_df['PTRIPSUNLINKED>2(AP)_OBS'], cal_rail_df['PTRIPSUNLINKED>2(AP)_SIM'], color=scatter_color_cal)
