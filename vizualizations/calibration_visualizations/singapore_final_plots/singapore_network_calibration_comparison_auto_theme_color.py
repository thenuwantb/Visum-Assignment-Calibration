...
plt.style.use('seaborn-dark-palette')  # seaborn-white, ggplot

save_path = "C:\\Users\\thenu\\OneDrive - tum.de\\Thesis\\1_Coding\\Experiments\\27022020_singapore_network\\results\\singapore_final_plots\\seaborn-dark-palette.svg"
...
ax1.plot(s_pax_trips_unlinked, alpha=alpha, label='boardings', linewidth=line_width, linestyle='-')
...
ax2.plot(a_pax_trips_unlinked, alpha=alpha, label='boardings', linewidth=line_width, linestyle='-')
...
ax3.plot(s_pax_trans_total, alpha=alpha, label='total', linewidth=line_width, linestyle='-')
...
ax4.plot(a_pax_trans_total, alpha=alpha, label='total', linewidth=line_width, linestyle='-')
