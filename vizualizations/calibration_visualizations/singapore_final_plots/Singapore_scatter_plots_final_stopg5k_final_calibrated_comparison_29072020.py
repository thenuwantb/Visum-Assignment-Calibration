...
stops_obs_df = pd.read_csv(
    "C:\\Users\\thenu\\OneDrive - tum.de\\Thesis\\1_Coding\\Experiments\\27022020_singapore_network\\observed_data\\to_plot\\observed_stop_data_all_movements_total_transfers_g_5000_07102020.csv")
...
cal_stops_sim_improved_df = pd.read_csv(
    "C:\\Users\\thenu\\OneDrive - tum.de\\Thesis\\1_Coding\\Experiments\\27022020_singapore_network\\results\\run_16\\run_16_simulated_results\\run_16_stops_sim.csv")
cal_line_route_sim_improved_df = pd.read_csv(
    "C:\\Users\\thenu\\OneDrive - tum.de\\Thesis\\1_Coding\\Experiments\\27022020_singapore_network\\results\\run_16\\run_16_simulated_results\\run_16_line_routes_sim.csv")
...
#save paths
save_path_modewise = "C:\\Users\\thenu\\OneDrive - tum.de\\Thesis\\1_Coding\\Experiments\\27022020_singapore_network\\results\\singapore_final_plots\\plots_with_custom_grid lines\\scatter\\test_26072020.svg"
save_path_transfer_type = "C:\\Users\\thenu\\OneDrive - tum.de\\Thesis\\1_Coding\\Experiments\\27022020_singapore_network\\results\\singapore_final_plots\\plots_with_custom_grid lines\\scatter\\test_transfer_type_26072020.svg"
...
save_path_transfer_type = "C:\\Users\\thenu\\OneDrive - tum.de\\Thesis\\1_Coding\\Experiments\\27022020_singapore_network\\results\\singapore_final_plots\\plots_with_custom_grid lines\\scatter\\test_transfer_flow_mode_26072020.svg"
...
############ plot for not calibrated model - repeat of fig3

save_path_transfer_type_not_calibrated = "C:\\Users\\thenu\\OneDrive - tum.de\\Thesis\\1_Coding\\Experiments\\27022020_singapore_network\\results\\singapore_final_plots\\plots_with_custom_grid lines\\scatter\\test_transfer_flow_mode_not_cal.svg"

# scatter plot passenger boardings with transfers across rail and bus
fig4, axs4 = plt.subplots(nrows=4, ncols=2, constrained_layout=True)
(ax27, ax28), (ax29, ax30), (ax31, ax32), (ax33, ax34) = axs4
#(ax19, ax20), (ax21, ax22), (ax23, ax24) = axs3
formatter1 = FuncFormatter(thousands)
...
scatter_plot_axis_2(ax27, ig_bus_df['PTRIPSUNLINKED0(AP)_OBS'], ig_bus_df['PTRIPSUNLINKED0(AP)_SIM'], color=scatter_color_cal)
ax27.set_title("(a.1) Pax. trips : 0 transfers - Bus", fontsize=subplot_title_size)
scatter_plot_axis_2(ax28, ig_rail_df['PTRIPSUNLINKED0(AP)_OBS'], ig_rail_df['PTRIPSUNLINKED0(AP)_SIM'], color=scatter_color_cal)
ax28.set_title("(a.2) Pax. trips : 0 transfers - LRT & MRT", fontsize=subplot_title_size)

scatter_plot_axis_2(ax29, ig_bus_df['PTRIPSUNLINKED1(AP)_OBS'], ig_bus_df['PTRIPSUNLINKED1(AP)_SIM'], color=scatter_color_cal)
ax29.set_title("(b.1) Pax. trips : 1 transfer - Bus", fontsize=subplot_title_size)
scatter_plot_axis_2(ax30, ig_rail_df['PTRIPSUNLINKED1(AP)_OBS'], ig_rail_df['PTRIPSUNLINKED1(AP)_SIM'], color=scatter_color_cal)
ax30.set_title("(b.2) Pax. trips : 1 transfer - LRT & MRT", fontsize=subplot_title_size)

scatter_plot_axis_2(ax31, ig_bus_df['PTRIPSUNLINKED2(AP)_OBS'], ig_bus_df['PTRIPSUNLINKED2(AP)_SIM'], color=scatter_color_cal)
ax31.set_title("(c.1) Pax. trips : 2 transfers - Bus", fontsize=subplot_title_size)
scatter_plot_axis_2(ax32, ig_rail_df['PTRIPSUNLINKED2(AP)_OBS'], ig_rail_df['PTRIPSUNLINKED2(AP)_SIM'], color=scatter_color_cal)
ax32.set_title("(c.2) Pax. trips : 2 transfers - LRT & MRT", fontsize=subplot_title_size)

scatter_plot_axis_2(ax33, ig_bus_df['PTRIPSUNLINKED>2(AP)_OBS'], ig_bus_df['PTRIPSUNLINKED>2(AP)_SIM'], color=scatter_color_cal)
ax33.set_title("(d.1) Pax. trips : > 2 transfers - Bus", fontsize=subplot_title_size)
scatter_plot_axis_2(ax34, ig_rail_df['PTRIPSUNLINKED>2(AP)_OBS'], ig_rail_df['PTRIPSUNLINKED>2(AP)_SIM'], color=scatter_color_cal)
ax34.set_title("(d.2) Pax. trips : > 2 transfers - LRT & MRT", fontsize=subplot_title_size)
...
fig4.savefig(save_path_transfer_type_not_calibrated)


######## Visum default - passenger trips
save_path_transfer_type_not_calibrated = "C:\\Users\\thenu\\OneDrive - tum.de\\Thesis\\1_Coding\\Experiments\\27022020_singapore_network\\results\\singapore_final_plots\\plots_with_custom_grid lines\\scatter\\test_transfer_flow_mode_visum_default.svg"

# scatter plot passenger boardings with transfers across rail and bus
fig5, axs5 = plt.subplots(nrows=4, ncols=2, constrained_layout=True)
(ax35, ax36), (ax37, ax38), (ax39, ax40), (ax41, ax42) = axs5

formatter1 = FuncFormatter(thousands)

scatter_plot_axis_2(ax35, vd_bus_df['PTRIPSUNLINKED0(AP)_OBS'], vd_bus_df['PTRIPSUNLINKED0(AP)_SIM'], color=scatter_color_vd)
ax35.set_title("(a.1) Pax. trips : 0 transfers - Bus", fontsize=subplot_title_size)
scatter_plot_axis_2(ax36, vd_rail_df['PTRIPSUNLINKED0(AP)_OBS'], vd_rail_df['PTRIPSUNLINKED0(AP)_SIM'], color=scatter_color_vd)
ax36.set_title("(a.2) Pax. trips : 0 transfers - LRT & MRT", fontsize=subplot_title_size)

scatter_plot_axis_2(ax37, vd_bus_df['PTRIPSUNLINKED1(AP)_OBS'], vd_bus_df['PTRIPSUNLINKED1(AP)_SIM'], color=scatter_color_vd)
ax37.set_title("(b.1) Pax. trips : 1 transfer - Bus", fontsize=subplot_title_size)
scatter_plot_axis_2(ax38, vd_rail_df['PTRIPSUNLINKED1(AP)_OBS'], vd_rail_df['PTRIPSUNLINKED1(AP)_SIM'], color=scatter_color_vd)
ax38.set_title("(b.2) Pax. trips : 1 transfer - LRT & MRT", fontsize=subplot_title_size)

scatter_plot_axis_2(ax39, vd_bus_df['PTRIPSUNLINKED2(AP)_OBS'], vd_bus_df['PTRIPSUNLINKED2(AP)_SIM'], color=scatter_color_vd)
ax39.set_title("(c.1) Pax. trips : 2 transfers - Bus", fontsize=subplot_title_size)
scatter_plot_axis_2(ax40, vd_rail_df['PTRIPSUNLINKED2(AP)_OBS'], vd_rail_df['PTRIPSUNLINKED2(AP)_SIM'], color=scatter_color_vd)
ax40.set_title("(c.2) Pax. trips : 2 transfers - LRT & MRT", fontsize=subplot_title_size)

scatter_plot_axis_2(ax41, vd_bus_df['PTRIPSUNLINKED>2(AP)_OBS'], vd_bus_df['PTRIPSUNLINKED>2(AP)_SIM'], color=scatter_color_vd)
ax41.set_title("(d.1) Pax. trips : > 2 transfers - Bus", fontsize=subplot_title_size)
scatter_plot_axis_2(ax42, vd_rail_df['PTRIPSUNLINKED>2(AP)_OBS'], vd_rail_df['PTRIPSUNLINKED>2(AP)_SIM'], color=scatter_color_vd)
ax42.set_title("(d.2) Pax. trips : > 2 transfers - LRT & MRT", fontsize=subplot_title_size)
...
fig5.savefig(save_path_transfer_type_not_calibrated)
