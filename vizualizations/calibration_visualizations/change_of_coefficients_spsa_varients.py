...
spsa_adaptiveStep = pd.read_csv(
    "C:\\Users\\thenuwan.jayasinghe\\OneDrive - tum.de\\Thesis\\1_Coding\\Experiments\\28012020_evaluate_spsa_varients\\results\\2_mumford_1_hp_13_ob_2\\far_cleaned\\spsa_adaptive_step_far_29012020_cleaned.csv")
spsa_weight = pd.read_csv(
    "C:\\Users\\thenuwan.jayasinghe\\OneDrive - tum.de\\Thesis\\1_Coding\\Experiments\\28012020_evaluate_spsa_varients\\results\\2_mumford_1_hp_13_ob_2\\far_cleaned\\spsa_weight_far_29012020_cleaned.csv")
spsa_aStepWeight = pd.read_csv(
    "C:\\Users\\thenuwan.jayasinghe\\OneDrive - tum.de\\Thesis\\1_Coding\\Experiments\\28012020_evaluate_spsa_varients\\results\\2_mumford_1_hp_13_ob_2\\far_cleaned\\spsa_aStep_weight_far_29012020_cleaned.csv")
...
_ = plt.plot(iteration_list, sv_originWaitTime_est, color='dimgrey', linewidth=1.0,
             label='Vanila SPSA')  # color = 'red'
_ = plt.plot(iteration_list, sw_originWaitTime_est, color='orangered', linewidth=1.2,
             label='Weight')  # color = 'darkorange'
_ = plt.plot(iteration_list, sa_originWaitTime_est, color='dodgerblue', linewidth=1.2,
             label='Adaptive Step')  # color = 'royalblue'
