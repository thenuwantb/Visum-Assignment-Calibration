...
unique_route_sum = data.groupby(['ORIGZONENO', 'DESTZONENO', 'NUMTRANSFERS', 'INVEHDIST'])[
...
data_df = pd.read_csv(
    "C:\\Users\\thenuwan.jayasinghe\\OneDrive - tum.de\\Thesis\\3_Analysis\\Direct Assignment\\sample_results_18022020.csv")

total_od_greater_10 = data_df['TOTAL_OD'] >= 10

data_od_greater_10_df = data_df[total_od_greater_10]
data_od_greater_10_df.to_csv(
    "C:\\Users\\thenuwan.jayasinghe\\OneDrive - tum.de\\Thesis\\3_Analysis\\Direct Assignment\\df1.csv")
# ===============================================================================
