...
***important - all the premeium routes and lines with no time tables removed in '111_Remove_premium_0.0475_mean_headway_28042020.ver'. the updated observed values csv file is used
...
# save results
save_result_path = "E:\\Thenuwan\\Singapore_Calibration\\data\\results\\run_12\\hp_set_13_spsa_02052020_run12.csv"
save_results_all_path = "E:\\Thenuwan\\Singapore_Calibration\\data\\results\\run_12\\hp_set_13_spsa_all_02052020_run12.csv"
...
initial_cost = initial_cost_dict[objective_function_1] + initial_cost_dict[objective_function_2]
results_all_df = results_all_df.append(sgs.parse_error_from_dict_to_df(simulated_error_dict=initial_cost_dict, current_estimate=initial_guess,objective_function=objective_function_1))
...
for k in range(max_iterations):
    ...
    cost_increase = cost_increase_dict[objective_function_1] + cost_increase_dict[objective_function_2]
    cost_decrease = cost_decrease_dict[objective_function_1] + cost_decrease_dict[objective_function_2]
    ...
    cost_new = cost_new_dict[objective_function_1] + cost_new_dict[objective_function_2]
    results_all_df = results_all_df.append(sgs.parse_error_from_dict_to_df(simulated_error_dict=cost_new_dict, current_estimate=current_estimate, objective_function=current_objective_function))
    # --------------fix 05122019---------------------------------
