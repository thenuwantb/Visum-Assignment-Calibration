...
# save results
save_result_path = "E:\\Thenuwan\\Singapore_Calibration\\data\\results\\run_6\\hp_set_13_spsa_13042020_run6.csv"
save_results_all_path = "E:\\Thenuwan\\Singapore_Calibration\\data\\results\\run_6\\hp_set_13_spsa_all_13042020_run6.csv"
...
for k in range(max_iterations):
    ...
    for m in range(len(previous_estimate)):
        if 1 <= previous_estimate[m] - gk_step_size[m] <= 9.0:
