...
3 objective functions will be used interchangebly At each iteration, the objective function which provides the highest difference will
...
# save results
save_result_path = "E:\\Thenuwan\\Singapore_Calibration\\data\\results\\run_8\\hp_set_13_spsa_21042020_run8.csv"
save_results_all_path = "E:\\Thenuwan\\Singapore_Calibration\\data\\results\\run_8\\hp_set_13_spsa_all_21042020_run8.csv"
...
objective_function_2 = 'pax_trans_walkb_trans_dir_combined_rmsn'
objective_function_3 = 'pax_trans_alightw_rmsn'
objective_function_list = [objective_function_1, objective_function_2, objective_function_3]

objective_function_count = {objective_function_1: 0, objective_function_2: 0, objective_function_3: 0}
...
for k in range(max_iterations):
    ...
    cost_increase_dict = sgs.runAssignmentCalculateErrorRMSN_all_error_terms(Visum=Visum, estimateList=increase_u,
                                                                             obs_stops_df=observed_stop_df,
                                                                             obs_line_routes=observed_line_route_df)
    cost_increase_list = [cost_increase_dict[objective_function_1], cost_increase_dict[objective_function_2], cost_increase_dict[objective_function_3]]

    cost_decrease_dict = sgs.runAssignmentCalculateErrorRMSN_all_error_terms(Visum=Visum, estimateList=decrease_u,
                                                                             obs_stops_df=observed_stop_df,
                                                                             obs_line_routes=observed_line_route_df)
    cost_decrease_list = [cost_decrease_dict[objective_function_1], cost_decrease_dict[objective_function_2], cost_decrease_dict[objective_function_3]]
