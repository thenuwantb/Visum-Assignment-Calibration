...
# save results
save_result_path = "E:\\Thenuwan\\Singapore_Calibration\\data\\results\\run_16\\hp_set_13_spsa_15072020_run16_calibrated_model.csv"
save_results_all_path = "E:\\Thenuwan\\Singapore_Calibration\\data\\results\\run_16\\hp_set_13_spsa_all_15072020_run16_calibrated_model.csv"
...
objective_function_1 = 'pax_trans_total_combined_mape'
objective_function_s_1 = 'pax_trips_unlinked_0_rmsn_0'
objective_function_s_2 = 'pax_trans_total_combined_rmsn_0'  # s = switching

objective_function_switch_list = [objective_function_1, objective_function_s_1, objective_function_s_2]
...
for k in range(max_iterations):
    ...
    if k < 15:
        ...
        cost_increase_list = [cost_increase_dict[objective_function_1], cost_increase_dict[objective_function_s_1], cost_increase_dict[objective_function_s_2]]
        cost_decrease_list = [cost_decrease_dict[objective_function_1], cost_decrease_dict[objective_function_s_1], cost_decrease_dict[objective_function_s_2]]
