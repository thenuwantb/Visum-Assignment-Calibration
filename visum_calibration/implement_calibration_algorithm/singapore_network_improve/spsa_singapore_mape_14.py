...
# save results
save_result_path = "E:\\Thenuwan\\Singapore_Calibration\\data\\results\\run_14\\hp_set_13_spsa_07072020_run14.csv"
save_results_all_path = "E:\\Thenuwan\\Singapore_Calibration\\data\\results\\run_14\\hp_set_13_spsa_all_07072020_run14.csv"
...
results_columns = ['transfer_walk', 'origin_wait', 'transfer_wait', 'transfer_penalty',
                   'pax_trans_total_rmsn', 'pax_trans_total_mape'
                                           'pax_trans_walkb_rmsn', 'pax_trans_walkb_mape', 'pax_trans_alightw_rmsn',
                   'pax_trans_alightw_mape', 'pax_trans_dir_rmsn',
                   'pax_trans_dir_mape', 'pax_trans_total_combined_rmsn', 'pax_trans_total_combined_mape',
                   'mean_pax_trans_combined_rmsn',
                   'pax_trans_walkb_trans_dir_combined_rmsn', 'pax_trips_unlinked_rmsn', 'pax_trips_unlinked_mape'
                                                                                         'pax_trips_unlinked_0_rmsn',
                   'pax_trips_unlinked_0_mape'
                   'pax_trips_unlinked_1_rmsn', 'pax_trips_unlinked_1_mape', 'pax_trips_unlinked_2_rmsn',
                   'pax_trips_unlinked_2_mape',
                   'pax_trips_unlinked_g_2_rmsn', 'pax_trips_unlinked_g_2_mape'
                                                  'paxTripsWoCon', 'objective_function']
...
initial_cost = initial_cost_dict[objective_function_2]
...
for k in range(max_iterations):
    ...
    current_objective_function = objective_function_2

    # objective_function_count[current_objective_function] += 1  # to keep a track
    cost_increase = cost_increase_dict[objective_function_2]
    cost_decrease = cost_decrease_dict[objective_function_2]
    ...
    cost_new = cost_new_dict[objective_function_2]
    results_all_df = results_all_df.append(
