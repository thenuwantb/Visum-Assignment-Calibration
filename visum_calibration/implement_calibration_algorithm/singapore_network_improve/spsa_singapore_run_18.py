'''
Best results from run 16 as the initial guess

first 4 - mape combined transfers
next 8 - rmsn with spsa dof
final 3 - mape with combined transfers
...
# save results
save_result_path = "E:\\Thenuwan\\Singapore_Calibration\\data\\results\\run_18\\hp_set_13_spsa_27072020_run18_calibrated_model.csv"
save_results_all_path = "E:\\Thenuwan\\Singapore_Calibration\\data\\results\\run_18\\hp_set_13_spsa_all_27072020_run18_calibrated_model.csv"
...
objective_function_s_2 = 'pax_trans_total_combined_rmsn'  # s = switching
...
initial_guess = [2.88598763200912, 1.11401236799087, 2.67411240570705, 4.77426819142956]
best_estimate = np.copy(initial_guess)
# ck =1 (its for 3) if your value is 2 =ck 1* 2/3, if the value is 5 ck 1*5/3
