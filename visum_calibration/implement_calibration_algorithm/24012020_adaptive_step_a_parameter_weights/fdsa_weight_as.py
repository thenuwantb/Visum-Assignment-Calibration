...
initial_guess = [1.07991565, 2.88600954, 3.51900674, 1.87816376, 1.60705385,
                 3.13857607]  # close [2.0, 2.8, 3.0, 1.0, 1.5, 2.0] # far [5.0, 5.0, 5.0, 5.0, 5.0, 5.0] #exact [1.0, 2.0, 2.0, 1.5, 2.0, 3.0] #farmost [9.0,9.0,9.0,9.0,9.0.9.0]
parameter_weights = [1, 1.0, 1, 1, 1,
                     1]  # calculated based on standard deviation of each parameter from the sensitivity analysis
